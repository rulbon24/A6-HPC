...
parLapply(cl, 1:n_loops, function(i) {
  random_numbers <- rnorm(n_samples, mean = mean_val, sd = sd_val)
  mean(random_numbers)
})
...
The theoretical speedup is 8 times faster, but the actual speedup is 3.16 times faster. The theoretical speedup is longer than the actual runtime because of overhead associated with parallelization, such as data transfer and cluster setup.
